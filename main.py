...
processor("data/extrait500_corpus_train_code_target.csv") # Création des tokenizers et adaptation sur le texte d'entrainement
...
train_ds = input_fn(dataset_name = "extrait500_corpus_train_code_target",batch_size =32, preprocess  = preprocess_train)
eval_ds = input_fn(dataset_name = "extrait500_corpus_val_code_target",batch_size =32, preprocess  = preprocess_train)
